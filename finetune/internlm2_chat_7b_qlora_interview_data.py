...
evaluation_inputs = [
    ...
    "您好，面试官，我的简历内容是：\nCharles，意向在北京工作, 我有一个'模拟面试官'的开源项目，使用人工收集总结的数据和生成数据，利用langchain、RAG、fine-tune、提示工程技术，实现了'复习面试题'、'模拟面试'等功能，同时，使用lmdeploy部署模型，在部分功能上利用fastapi框架进行前后端分离，这使得界面整洁优美，支持模型部署在不同的设备上。我的求职岗位是大模型应用工程师，我希望能够更加深入地了解大模型的预训练、微调、部署、推理和加速等知识。\n，请开始面试"
]
